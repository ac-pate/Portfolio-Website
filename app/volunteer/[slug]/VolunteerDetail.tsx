      ...
      <article className="section-container">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-6">
            {/* Icon */}
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl overflow-hidden bg-red-500/10 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl text-accent mb-2">{frontmatter.organization}</p>
