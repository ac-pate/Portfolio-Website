...
endDate: 2025-12-01
description: Working on CRAWLR (Concordia Robotic Articulated Wheel-Legged
  Rover), an experimental space-rover platform for push–pull locomotion research
  in unstructured planetary terrain.
technologies:
  - ROS2
  - Python
  - C++
