...
description: A, 3D-printed, 6-DOF robotic arm with custom cycloidal actuator and
  build on ROS2 framework to use tool such as Gazebo and Moveit2 along with our
  custom hardware, URDFs, Controllers interfaces for our custom robot.
date: 2024-06-01
endDate: 2025-04-30
tags:
  - ROS2
  ...
  - Jetson Nano
  - 3D Printing
image: /images/uploads/img_9902.jpg
